...
This allows the optimization to accumulate speed in the direction
...
preservation of velocity vector $\mb{v}$,
...
We use 1000 nodes in each hidden layer, 
creating a structure of 784-1000-1000-10 nodes in each layer.
We also chose ReLU for $g(\cdot)$ in the hidden layers,
...
dataset,
we reach a test error rate of $16\%$.
%
\begin{figure}[h]
\centering
...
However, this will not explored since it is not
...
This will explored further in future discussions.
