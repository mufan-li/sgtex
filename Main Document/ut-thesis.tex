...
\begin{titlepage}
    \begin{center}
        \vspace*{1cm}
        \Huge
        \textbf{Collaborative Filtering for Student Grade Analysis}
        ...
        \textbf{Mufan Li} \\
        \large
        \textbf{Supervisor: Jeffrey Rosenthal, Albert Yoon}
        
        \vfill
        \large
        % A research report presented for the degree of\\
        % Master of Science
...
\input{intro}
\input{background}
\input{background_mnist}
\input{background_unsup}
\input{results}
% \input{conclusion}
